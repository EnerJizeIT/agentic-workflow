...
### NEG-2026-09-19 · Воркер: пустой «ask» на санкционированные внешние пути

**Source:** topic-trainer TODO-0013, стадия implementer
(`awf-improvement-spec.md` D11, живое свидетельство в логе
`awf-agent-implementer-TODO-0013.out`).
