...
├── tests/                         # 857 tests (e2e + unit + integration + plugin)
└── BACKLOG.md                     # roadmap
```
...
**857 тестов:** e2e + unit (awf, включая `test_api.py` 84 тестов) + integration (awf) + integration/unit (plugin, включая `test_awf_tools.py` 30 тестов).
